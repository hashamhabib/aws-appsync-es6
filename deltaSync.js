...
import * as offline_1 from './helpers/offline';

// var offline_link_1 = require("./link/offline-link");
import * as offline_link_1 from './link/offline-link';
...
export function hashForOptions(options) {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    hash = hashForOptions(options);
                    itemInHash = store.getState()[offline_cache_1.METADATA_KEY][DELTASYNC_KEY].metadata[hash];
                    ...
                    enqueueAgain = function () {
                        ...
                        boundEnqueueDeltaSync(store, __assign({}, options, { lastSyncTimestamp: lastSyncTimestamp, baseLastSyncTimestamp: baseLastSyncTimestamp }), observer, callback);
                    };
...
var reducer = function () {
    return function (state, action) {
        ...
        switch (action.type) {
            ...
            default:
                var newState = __assign({}, state, (_a = {}, _a[DELTASYNC_KEY] = __assign({ metadata: {} }, state.deltaSync), _a));
                return newState;
        }
    };
};
var lastSyncReducer = function (state, action) {
    ...
    var _d = state[DELTASYNC_KEY], metadata = _d.metadata, deltaSync = __rest(_d, ["metadata"]);
    ...
    var newState = __assign({}, state, (_a = {}, _a[DELTASYNC_KEY] = __assign({}, deltaSync, { metadata: __assign({}, otherHashes, (_b = {}, _b[hash] = newMetadata, _b)) }), _a));
    return newState;
};
var metadataReducer = function (state, action) {
    ...
    var metadata = state[DELTASYNC_KEY].metadata;
    var hash = hashForOptions(options);
    ...
    var newState = __assign({}, state, (_a = {}, _a[DELTASYNC_KEY] = {
        metadata: __assign({}, metadata, (_b = {}, _b[hash] = newMetadata, _b))
    }, _a));
    return newState;
};
export  function boundEnqueueDeltaSync(store, options, observer, callback) {
...
//#endregion
//#region Builder
export function buildSync(typename, options, idField) {
