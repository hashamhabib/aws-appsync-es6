...
import * as redux_1 from 'redux/es';
// var redux_offline_1 = require("@redux-offline/redux-offline");
import * as redux_offline_1 from '@redux-offline/redux-offline';
...
// var console.log = utils_1.rootconsole.log.extend('store');
...
var effect = function (effect, action, store, clientGetter, callback, offlineStatusChangeCallbackCreator) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        console.log("No effect found for " + action.type);
        return [2 /*return*/];
    });
}); };
var discard = function (callback, error, action, retries) {
    ...
    if (discard) {
        console.log("Executing discard for " + action.type, discard);
        return discard(callback, error, action, retries);
    }
    console.log("No custom discard found for " + action.type + ". Discarding effect.");
    return true;
};
