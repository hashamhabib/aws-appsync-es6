...
import * as apollo_link_context_1 from 'apollo-link-context';
var NonTerminatingLink = /** @class */ (function (_super) {
    ...
    NonTerminatingLink.prototype.request = function (operation, forward) {
        var _this = this;
        return apollo_link_context_1.setContext(function (_request, prevContext) {
