...
import * as complex_object_link_uploader_1 from './complex-object-link-uploader';
...
var ComplexObjectLink = /** @class */ (function (_super) {
    ...
    function ComplexObjectLink(credentials) {
        ...
        _this.link = complexObjectLink(credentials);
        return _this;
    }
...
export { ComplexObjectLink };
export function complexObjectLink(credentials) {
        ...
        return new apollo_link_1.Observable(function (observer) {
            ...
            if (Object.keys(objectsToUpload).length) {
                ...
                uploadPromise = Promise.resolve(uploadCredentials)
                    ...
                    .catch(function (err) {
                        var error = new GraphQLError(err.message);
