...
var SubscriptionHandshakeLink = /** @class */ (function (_super) {
    ...
    function SubscriptionHandshakeLink(subsInfoContextKey) {
        ...
        _this.onMessage = function (topic, message, selectionNames) {
            ...
            console.log('Message received', { data: data, topic: topic, observers: observers });
    ...
    SubscriptionHandshakeLink.prototype.request = function (operation) {
        var _this = this;
        var _a = operation.getContext(), _b = this.subsInfoContextKey, subsInfo = _a[_b], _c = _a.controlMessages, _d = CONTROL_EVENTS_KEY, controlEvents = (_c === void 0 ? {} : _c)[_d];
...
export { SubscriptionHandshakeLink };
